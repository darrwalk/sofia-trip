...
export const events: EventItem[] = [
...

  {
    name: 'Skillet',
    category: 'concert',
    description: 'American rock band with massive arena production. 20M+ albums sold. High-energy live show with pyrotechnics. Playing the night before you arrive.',
    date: '2026-05-14',
    location: 'Arena Armeec Sofia',
    url: 'https://concerts50.com/show/skillet-in-sofia-tickets-may-14-2026',
    mapUrl: 'https://maps.google.com/?q=Arena+Armeec+Sofia',
    note: 'Thu night — only if you arrive early. Tickets from лв109 (~€55).',
  },
  {
    name: 'Redman',
    category: 'concert',
    description: 'Hip-hop legend. One of the greatest MCs alive — raw, funny, chaotic live shows. Playing Joy Station the night before you arrive.',
    date: '2026-05-14',
    location: 'Joy Station',
    url: 'https://concerts50.com/show/redman-in-sofia-tickets-may-14-2026',
    mapUrl: 'https://maps.google.com/?q=Joy+Station+Sofia',
    note: 'Thu night. Tickets from лв113 (~€58). Intimate venue = incredible experience.',
  },
  {
    name: 'Tinariwen',
    category: 'concert',
    ...
    date: '2026-05-15',
    location: 'NDK Hall 3',
    url: 'https://concerts50.com/show/tinariwen-in-sofia-tickets-may-15-2026',
    mapUrl: 'https://maps.google.com/?q=NDK+Hall+3+Sofia',
    note: 'Tickets from лв90 (~€46). Friday night arrival → straight to Tinariwen.',
  },
  {
  ...
  {
    name: 'Gabrovo Carnival',
    category: 'festival',
    description: 'Bulgaria\'s famous Carnival of Humor — the whole town of Gabrovo becomes a massive street party with parades, costumes, satire floats, live music, and absurdist humor. Think Carnival meets Monty Python. One of Bulgaria\'s most beloved annual events.',
    date: '2026-05-16',
    location: 'Gabrovo (2.5h drive from Sofia)',
    url: 'https://carnival.gabrovo.bg/en/home/',
    mapUrl: 'https://maps.google.com/?q=Gabrovo+Bulgaria',
    note: 'Saturday! Perfect day trip. Gabrovo is also home to the Museum of Humor & Satire.',
  },
  {
    name: 'European Museum Night',
    category: 'festival',
    description: 'Annual pan-European event — museums across Bulgaria open their doors for FREE with special evening programs, performances, and installations. A magical night of culture.',
    date: '2026-05-18',
    location: 'Museums across Sofia',
    url: 'https://en.wikipedia.org/wiki/Night_of_Museums',
    note: 'Monday — your last evening. Free entry everywhere. Great way to end the trip.',
  },
  ...
  },
  {
    name: 'Yalta Club',
    category: 'nightlife',
    description: 'LEGENDARY. Sofia\'s premier techno club since 1959 — one of Europe\'s oldest nightclubs. Two rooms: panoramic upstairs + raw underground basement. Ricardo Villalobos, Adam Beyer, Hernan Cattaneo have all played here. The underground room is where the magic happens.',
    location: 'bul. Tsar Osvoboditel 20',
    url: 'https://www.google.com/maps/place/Yalta/@42.6927904,23.3312852',
    mapUrl: 'https://maps.google.com/?q=Yalta+Club+Sofia',
    note: 'Entry 10-20 BGN. Often goes until 6 AM. Check FB for that weekend\'s lineup.',
  },
  {
    name: 'Kupe',
    category: 'nightlife',
    description: 'Industrial-chic techno venue. Exposed brick, metal frameworks, atmospheric lighting. Different genres each night. The young, in-the-know crowd\'s favorite.',
    location: 'Slavyanska & Shesti Septemvri',
    url: 'https://www.google.com/maps/place/KUPE',
    mapUrl: 'https://maps.google.com/?q=Kupe+Club+Sofia',
  },
  {
    name: 'Bar Petak (Friday Bar)',
    category: 'nightlife',
    description: 'Running since 2008. Insanely eclectic music: reggae → funk → D&B → trap → soul in one night. The crowd is genuinely interesting people, not just partiers. Some of the best conversations in Sofia happen here.',
    location: 'ul. Stefan Karadzha 1',
    url: 'https://www.google.com/maps/place/Bar+Friday',
    mapUrl: 'https://maps.google.com/?q=Bar+Petak+Sofia',
    note: 'Opens 11 PM, goes until 4 AM.',
  },
  {
    name: 'Chalga Night — Club 33',
    category: 'nightlife',
    description: 'You MUST experience chalga — Bulgaria\'s unique pop-folk genre. Euro-house beats + Balkan rhythms + powerful vocals. People throw napkins like confetti (it\'s tradition). Rakia shots flow. Pure chaos. Nothing like it anywhere else in Europe.',
    location: 'Studentski Grad',
    url: 'https://www.google.com/maps/place/Club+33+Sofia',
    mapUrl: 'https://maps.google.com/?q=Club+33+Sofia',
    note: 'This is THE authentic Bulgarian nightlife experience. Opens 11 PM. Embrace the madness.',
  },
