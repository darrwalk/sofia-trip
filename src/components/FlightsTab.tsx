          ...
          <table className="w-full">
            <thead>
              <tr className="border-b-2 border-emerald-100 text-xs text-emerald-700 uppercase bg-emerald-50">
                <th className="text-left py-2 px-2 sm:py-3 sm:px-4">Time</th>
                <th className="text-left py-2 px-2 sm:py-3 sm:px-4">Who</th>
                <th className="text-left py-2 px-2 sm:py-3 sm:px-4">From</th>
                <th className="text-left py-2 px-2 sm:py-3 sm:px-4 hidden sm:table-cell">Flight</th>
              </tr>
            </thead>
            <tbody>
              {arrivals.map((flight, i) => (
                <tr key={i} className="border-b border-emerald-50 last:border-0 hover:bg-emerald-50/50">
                  <td className="py-3 px-2 sm:py-4 sm:px-4">
                    <span className="text-lg sm:text-2xl font-bold text-gray-800">{flight.arrival.time}</span>
                  </td>
                  <td className="py-3 px-2 sm:py-4 sm:px-4">
                    <span className="font-bold text-orange-600 text-base sm:text-lg">{flight.passenger}</span>
                  </td>
                  <td className="py-3 px-2 sm:py-4 sm:px-4">
                    <span className="text-gray-700 font-medium">{flight.departure.code}</span>
                    {flight.departure.code !== '???' && (
                      <span className="text-gray-500 text-sm ml-1 hidden sm:inline">({flight.departure.airport})</span>
                    )}
                  </td>
          ...
          <table className="w-full">
            <thead>
              <tr className="border-b-2 border-blue-100 text-xs text-blue-700 uppercase bg-blue-50">
                ...
                <th className="text-left py-2 px-2 sm:py-3 sm:px-4">Time</th>
                <th className="text-left py-2 px-2 sm:py-3 sm:px-4">Who</th>
                <th className="text-left py-2 px-2 sm:py-3 sm:px-4">To</th>
                <th className="text-left py-2 px-2 sm:py-3 sm:px-4 hidden sm:table-cell">Flight</th>
              </tr>
            </thead>
            <tbody>
              {departures.map((flight, i) => {
                ...
                return (
                  <tr key={i} className="border-b border-blue-50 last:border-0 hover:bg-blue-50/50">
                    <td className="py-3 px-2 sm:py-4 sm:px-4">
                      <span className="text-gray-700 font-medium text-sm sm:text-base">{dateStr}</span>
                    </td>
                    <td className="py-3 px-2 sm:py-4 sm:px-4">
                      <span className="text-lg sm:text-2xl font-bold text-gray-800">{flight.departure.time}</span>
                    </td>
                    <td className="py-3 px-2 sm:py-4 sm:px-4">
                      <span className="font-bold text-orange-600 text-base sm:text-lg">{flight.passenger}</span>
                    </td>
                    <td className="py-3 px-2 sm:py-4 sm:px-4">
                      ...
                      <span className="text-gray-500 text-sm ml-1 hidden sm:inline">({flight.arrival.airport})</span>
                    </td>
                    <td className="py-3 px-2 sm:py-4 sm:px-4 hidden sm:table-cell">
                      {flight.flightNumber ? (
                        <span className="text-gray-600 font-mono bg-gray-100 px-2 py-1 rounded">{flight.flightNumber}</span>
